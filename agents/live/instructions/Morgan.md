...
- **Primary:** `agents/live/CHECKLIST.md` – any task with Owner **Morgan** and Status **Pending**.
- **Specs:** `SCT_System_Recreation_Project/SCT_Enhanced_System_Design_And_Build_Scope.md` (AI), `SCT_AI_and_Human_Operating_Model.md`.

## Rules

- When you complete a task: update CHECKLIST, `agents/live/checklists/`, and `agents/live/build-notes/Morgan.md`; update this file if your focus changes. When you start: read CHECKLIST, STATUS, this file, and recent build-notes first.
